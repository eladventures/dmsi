                    ...
                    <div className="bg-card rounded-2xl border p-8 md:p-12 shadow-sm">
                        ...
                        <section className="mb-8">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                <strong>Contact:</strong> compliance@damarketsec.com | (02) 8887-5457 (0917) 863 3119
                            </p>
                        </section>
                        ...
                        <section className="mb-8">
                            ...
                            <ul className="text-muted-foreground list-disc pl-6">
                                <li><strong>Website:</strong> <a href="https://privacy.gov.ph/filing-a-complaint/" className="text-brand-primary hover:underline">privacy.gov.ph</a></li>
